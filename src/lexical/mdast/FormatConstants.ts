// Ported from ../editor (MDXEditor) FormatConstants.ts — mirrors Lexical's
// TextNode format bitmask. Kept identical to the source for reconciliation,
// even though the composer's MVP subset only produces bold/italic/strikethrough/code.
